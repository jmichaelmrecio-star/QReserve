...
function initializePaymentReminderModal() {
  ...
  // Note: Browser security prevents custom modals during beforeunload.
  // The custom paymentReminderModal handles internal navigation (links).
  // External navigation (closing tab, back button) cannot be intercepted with custom modals.
  ...
  document.addEventListener("click", function (e) {
    ...
    if (
      ...
      !href.startsWith("#") &&
      target.id !== "continuePaymentLaterBtn"
    ) {
