...
const resortServices = [
  // === VILLA ROOMS ===
  {
    ...
    durations: [
      { id: "duration_12h", label: "12 Hours", hours: 12, price: 3000.0 },
      { id: "duration_22h", label: "22 Hours", hours: 22, price: 4000.0 },
    ],
  ...
  },
  {
    ...
    durations: [
      { id: "duration_12h", label: "12 Hours", hours: 12, price: 4000.0 },
      { id: "duration_22h", label: "22 Hours", hours: 22, price: 6000.0 },
    ],
    defaultDuration: "duration_12h",
    inclusions: [
      "Hot and cold shower",
  ...
  },
  {
    ...
    durations: [
      { id: "duration_12h", label: "12 Hours", hours: 12, price: 2000.0 },
      { id: "duration_22h", label: "22 Hours", hours: 22, price: 4000.0 },
    ],
    defaultDuration: "duration_12h",
    inclusions: [
  ...
  // === VENUES ===
  {
    ...
    durations: [
      { id: "duration_3h", label: "3 Hours", hours: 3, price: 8000.0 },
      { id: "duration_5h", label: "5 Hours", hours: 5, price: 12000.0 },
    ],
  ...
  },
  {
    ...
    timeSlots: [
      { id: "slot_day", label: "Day (7am - 5pm)", timeRange: "day", price: 12000.0 },
      { id: "slot_night", label: "Night (7pm - 5am)", timeRange: "night", price: 15000.0 },
    ],
...
async function seedServices() {
    try {
        ...
        for (const service of resortServices) {
            console.log(`Upserting service: ${service.name} (${service.id})...`);
